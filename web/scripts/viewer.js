...
function loadScene() {
    ...
    {    
        ...
        BABYLON.SceneLoader.Load(rootUrl, fileName, engine, function (scene) {
            ...
            var mainMesh = new BABYLON.Mesh("mainModelMesh", scene);
			...
			var skyboxScale     = 4.0 * camera.upperRadiusLimit;
			var skyboxBlurLevel = 0.5;
			
			scene.createDefaultSkybox(scene.environmentTexture, true, skyboxScale, skyboxBlurLevel);
